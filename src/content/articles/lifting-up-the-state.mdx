...
description: native state management
...
Upon the submission of the form above, the browser's default behaviour would be to navigate to the current URL + the fields of the form as search parameters; if the form was in the current page, `https://www.miltondavid.com/blog/lifting-up-the-state`, after the submission the new URL would be 
